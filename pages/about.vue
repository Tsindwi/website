  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="prose max-w-none">
      ...
      >
        ...
        and tired of ineffective systems, particularly in immigration. We bring together technical
        enthusiasts and changemakers to build scalable, innovative solutions to global challenges.
      </p>

      <h2 
        class="text-2xl font-bold mt-12 mb-6"
        v-motion
        :initial="{ opacity: 0, y: 50 }"
        :enter="{ opacity: 1, y: 0 }"
        :delay="400"
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div 
          ...
          :key="member.id"
          class="bg-white p-6 rounded-lg shadow transform hover:-translate-y-2 transition-all duration-300"
          v-motion
          :initial="{ opacity: 0, y: 50 }"
          :enter="{ opacity: 1, y: 0 }"
          :delay="600 + (index * 200)"
